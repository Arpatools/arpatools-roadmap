...
- Eine FTP-Verbindung zu SellerLogic, eingerichtet unter den Jobby-FTP-Servern (siehe
  [Jobby-Dokumentation](/doku/jobby), Abschnitt „FTP-Server"). Die Zugangsdaten und Ihre Seller-ID
  erhalten Sie von SellerLogic.
...
- **Allgemein:** Übertragungsweg, FTP-Server, Seller-ID, Marktplätze, Versandart, Optimierung und
  der Filter, welche Artikel überhaupt übertragen werden.
- **Kosten & Preise:** Preismodus, die fünf Kostenarten und die Preisgrenzen der Automatik.
...
- **Repricing aktiv/inaktiv:** steuert, ob SellerLogic die übertragenen Angebote optimiert.
- **Einkaufspreis mitsenden:** ja/nein.
